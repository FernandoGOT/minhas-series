        ...
        <div className='container'>
          ...
          <form>
            <div className='form-group'>
              ...
              <input autoFocus type='text' value={form.name} onChange={onChange('name')} className='form-control' id='name' aria-placeholder='Nome da série' />
            </div>
            <div className='form-group'>
            ...
            <div className='form-group'>
              ...
              <input type='text' value={form.comments || ''} onChange={onChange('comments')} className='form-control' id='name' aria-placeholder='Comentários' />
            </div>
            ...
            <button type='button'  onClick={() => setMode('INFO')} className='btn btn-primary'>Cancelar edição</button>
